...
-- Target date context: August 2026
-- Safe to re-run: rows use deterministic UUIDs and upserts.
--
-- IMPORTANT:
-- 1) Run supabase/migrations/001_reseller360.sql first.
-- 2) Create khaled.yakan@incheck360.nl in Supabase Authentication first.
-- 3) Run this file in the Supabase SQL Editor.
--
-- This seed promotes that existing Auth user to platform admin and fills every
-- major module: resellers, shared companies, CRM, clients, locations, licences,
-- renewals, requests, invoices, schedules, payments, receipts and audit history.
...
-- Keep generated production document numbers away from the demo range.
...
on conflict (id) do update set
  code=excluded.code, name=excluded.name, legal_name=excluded.legal_name,
  country=excluded.country, currency=excluded.currency, billing_email=excluded.billing_email,
  payment_term_days=excluded.payment_term_days, status=excluded.status;
...
on conflict (id) do update set
  company_name=excluded.company_name, legal_name=excluded.legal_name, website=excluded.website,
  country=excluded.country, city=excluded.city, industry=excluded.industry,
  company_size=excluded.company_size, linkedin_url=excluded.linkedin_url;

-- ---------------------------------------------------------------------------
-- Reseller/company ownership and shared-market stages
-- ---------------------------------------------------------------------------
...
on conflict (id) do update set
  reseller_id=excluded.reseller_id, company_id=excluded.company_id, stage=excluded.stage,
  contacted=excluded.contacted, is_active_client=excluded.is_active_client;
...
begin
  ...
  (id,reseller_id,company_id,first_name,last_name,job_title,email,phone,linkedin_url,is_decision_maker,notes,created_by)
  values
  ('00000000-0000-0000-0000-000000000301','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000201','Maya','Haddad','Group Operations Director','maya.haddad@atlas-demo.example','+971 50 555 0101',null,true,'Primary operations decision maker. Prefers morning follow-ups.',v_admin),
  ('00000000-0000-0000-0000-000000000302','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000205','Omar','Rahman','COO','omar.rahman@urbanspoon-demo.example','+971 50 555 0102',null,true,'Interested in centralised location reporting.',v_admin),
  ('00000000-0000-0000-0000-000000000303','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000207','Sarah','Nasser','Quality Manager','sarah.nasser@marinaleisure-demo.example','+971 50 555 0103',null,false,'Requested a product overview for the operations team.',v_admin),
  ('00000000-0000-0000-0000-000000000304','00000000-0000-0000-0000-000000000102','00000000-0000-0000-0000-000000000202','Rami','Khoury','Managing Director','rami.khoury@cedartable-demo.example','+961 3 555 104',null,true,'Existing active client contact.',v_admin),
  ('00000000-0000-0000-0000-000000000305','00000000-0000-0000-0000-000000000102','00000000-0000-0000-0000-000000000210','Nadine','Saab','General Manager','nadine.saab@beirutboutique-demo.example','+961 3 555 105',null,true,'Commercial proposal under review.',v_admin),
  ('00000000-0000-0000-0000-000000000306','00000000-0000-0000-0000-000000000103','00000000-0000-0000-0000-000000000203','Faisal','Al Saud','Head of Operations','faisal@riyadheats-demo.example','+966 55 555 0106',null,true,'Existing client; discussing additional branches.',v_admin),
  ('00000000-0000-0000-0000-000000000307','00000000-0000-0000-0000-000000000103','00000000-0000-0000-0000-000000000208','Lina','Mansour','Operations Manager','lina@desertroastery-demo.example','+966 55 555 0107',null,true,'Renewal discussion started.',v_admin),
  ('00000000-0000-0000-0000-000000000308','00000000-0000-0000-0000-000000000104','00000000-0000-0000-0000-000000000206','Yazan','Haddadin','Founder','yazan@ammanfoodworks-demo.example','+962 7 9555 0108',null,true,'Qualified lead, wants September launch.',v_admin)
  on conflict (id) do update set
    reseller_id=excluded.reseller_id, company_id=excluded.company_id, first_name=excluded.first_name,
    last_name=excluded.last_name, job_title=excluded.job_title, email=excluded.email, phone=excluded.phone,
    is_decision_maker=excluded.is_decision_maker, notes=excluded.notes, created_by=excluded.created_by;
end $$;
...
begin
  ...
  values
  ('00000000-0000-0000-0000-000000000401','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000205','00000000-0000-0000-0000-000000000302','Urban Spoon rollout','LinkedIn','qualified','high',4200,'USD','2026-08-14','Potential 5-location rollout.',v_admin),
  ('00000000-0000-0000-0000-000000000402','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000207','00000000-0000-0000-0000-000000000303','Marina Leisure operations digitisation','Referral','contacted','medium',2750,'USD','2026-08-18','Awaiting operational requirements.',v_admin),
  ('00000000-0000-0000-0000-000000000403','00000000-0000-0000-0000-000000000102','00000000-0000-0000-0000-000000000210','00000000-0000-0000-0000-000000000305','Boutique Hotels quality platform','Event','qualified','high',3600,'USD','2026-08-13','Three hotels in first phase.',v_admin),
  ...
  ('00000000-0000-0000-0000-000000000406','00000000-0000-0000-0000-000000000104','00000000-0000-0000-0000-000000000206','00000000-0000-0000-0000-000000000308','Amman Food Works launch','Website','qualified','urgent',1900,'USD','2026-08-13','Target go-live in September.',v_admin),
  ('00000000-0000-0000-0000-000000000407','00000000-0000-0000-0000-000000000104','00000000-0000-0000-0000-000000000212',null,'Olive Branch Kitchens prospect','Outbound','new','low',1400,'USD','2026-08-28','Not contacted yet.',v_admin)
  on conflict (id) do update set
    status=excluded.status, priority=excluded.priority, estimated_value=excluded.estimated_value,
    next_follow_up=excluded.next_follow_up, notes=excluded.notes, created_by=excluded.created_by;
end $$;
...
begin
  ...
  values
  ('00000000-0000-0000-0000-000000000501','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000205','00000000-0000-0000-0000-000000000302','00000000-0000-0000-0000-000000000401','Urban Spoon - 5 locations','proposal',4200,'USD',70,'2026-08-25','InCheck Full',5,'Follow up on proposal approval','Demo completed successfully.',v_admin),
  ('00000000-0000-0000-0000-000000000502','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000207','00000000-0000-0000-0000-000000000303','00000000-0000-0000-0000-000000000402','Marina Leisure pilot','qualified',2750,'USD',45,'2026-09-10','InCheck Full',3,'Schedule discovery workshop','Pilot scope still being defined.',v_admin),
  ('00000000-0000-0000-0000-000000000503','00000000-0000-0000-0000-000000000102','00000000-0000-0000-0000-000000000210','00000000-0000-0000-0000-000000000305','00000000-0000-0000-0000-000000000403','Beirut Boutique Hotels','negotiation',3600,'USD',80,'2026-08-21','InCheck Full',3,'Confirm commercial terms','Management requested final pricing.',v_admin),
  ...
  ('00000000-0000-0000-0000-000000000505','00000000-0000-0000-0000-000000000103','00000000-0000-0000-0000-000000000205',null,'00000000-0000-0000-0000-000000000405','Urban Spoon KSA expansion','demo',3000,'USD',55,'2026-09-05','InCheck Full',4,'Run product demo','Demo booked with KSA team.',v_admin),
  ('00000000-0000-0000-0000-000000000506','00000000-0000-0000-0000-000000000104','00000000-0000-0000-0000-000000000206','00000000-0000-0000-0000-000000000308','00000000-0000-0000-0000-000000000406','Amman Food Works launch','qualified',1900,'USD',65,'2026-08-28','InCheck Basic',2,'Send proposal','Client requested a two-location start.',v_admin),
  ('00000000-0000-0000-0000-000000000507','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000201','00000000-0000-0000-0000-000000000301',null,'Atlas initial rollout','won',2475,'USD',100,'2026-06-15','InCheck Full',3,'Client activated','Historical won deal for active client.',v_admin),
  ...
  on conflict (id) do update set
    stage=excluded.stage, value=excluded.value, probability=excluded.probability,
...
begin
  ...
  values
  ('00000000-0000-0000-0000-000000000601','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000205','00000000-0000-0000-0000-000000000302','00000000-0000-0000-0000-000000000401','00000000-0000-0000-0000-000000000501','demo','Product demo completed','Demo covered dashboards, inspections and multi-location reporting.','2026-08-10 10:00:00+03','2026-08-14 10:00:00+03',v_admin),
  ('00000000-0000-0000-0000-000000000602','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000207','00000000-0000-0000-0000-000000000303','00000000-0000-0000-0000-000000000402','00000000-0000-0000-0000-000000000502','call','Discovery call','Discussed quality checks and three initial sites.','2026-08-09 15:30:00+03','2026-08-18 11:00:00+03',v_admin),
  ('00000000-0000-0000-0000-000000000603','00000000-0000-0000-0000-000000000102','00000000-0000-0000-0000-000000000210','00000000-0000-0000-0000-000000000305','00000000-0000-0000-0000-000000000403','00000000-0000-0000-0000-000000000503','email','Final pricing shared','Shared revised commercial offer with management.','2026-08-11 09:15:00+03','2026-08-13 12:00:00+03',v_admin),
  ('00000000-0000-0000-0000-000000000604','00000000-0000-0000-0000-000000000102','00000000-0000-0000-0000-000000000211',null,'00000000-0000-0000-0000-000000000404','00000000-0000-0000-0000-000000000504','linkedin','Initial outreach sent','Introductory LinkedIn message sent to operations team.','2026-08-08 14:00:00+03','2026-08-20 10:00:00+03',v_admin),
  ('00000000-0000-0000-0000-000000000605','00000000-0000-0000-0000-000000000103','00000000-0000-0000-0000-000000000205',null,'00000000-0000-0000-0000-000000000405','00000000-0000-0000-0000-000000000505','meeting','KSA discovery meeting','KSA operating team requested a dedicated demo.','2026-08-11 13:00:00+03','2026-08-22 13:00:00+03',v_admin),
  ('00000000-0000-0000-0000-000000000606','00000000-0000-0000-0000-000000000104','00000000-0000-0000-0000-000000000206','00000000-0000-0000-0000-000000000308','00000000-0000-0000-0000-000000000406','00000000-0000-0000-0000-000000000506','whatsapp','Launch timing confirmed','Client wants September implementation if proposal is approved.','2026-08-12 09:00:00+03','2026-08-13 09:00:00+03',v_admin),
  ('00000000-0000-0000-0000-000000000607','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000201','00000000-0000-0000-0000-000000000301',null,'00000000-0000-0000-0000-000000000507','note','Client health check','Atlas usage and rollout are healthy.','2026-08-05 11:00:00+03',null,v_admin),
  ('00000000-0000-0000-0000-000000000608','00000000-0000-0000-0000-000000000103','00000000-0000-0000-0000-000000000208','00000000-0000-0000-0000-000000000307',null,null,'follow_up','Renewal follow-up','Renewal confirmation requested before expiry.','2026-08-12 10:30:00+03','2026-08-17 10:30:00+03',v_admin)
  on conflict (id) do update set
    activity_type=excluded.activity_type, subject=excluded.subject, details=excluded.details,
    activity_at=excluded.activity_at, next_follow_up=excluded.next_follow_up, created_by=excluded.created_by;
end $$;
...
(id,reseller_id,company_id,status,activated_at)
values
...
('00000000-0000-0000-0000-000000000803','00000000-0000-0000-0000-000000000701','00000000-0000-0000-0000-000000000701','Atlas Business Bay','United Arab Emirates','Dubai','Business Bay','active','2026-02-01'),
...
on conflict (id) do update set
  location_name=excluded.location_name, country=excluded.country, city=excluded.city,
  address=excluded.address, status=excluded.status, activated_at=excluded.activated_at;

-- Correct one deterministic location row if an earlier seed version existed with a wrong reseller id.
update public.client_locations
set reseller_id='00000000-0000-0000-0000-000000000101'
...
on conflict (id) do update set
  product_name=excluded.product_name, quantity=excluded.quantity, annual_value=excluded.annual_value,
  start_date=excluded.start_date, expiry_date=excluded.expiry_date,
  billing_frequency=excluded.billing_frequency, payment_term_days=excluded.payment_term_days,
...
('00000000-0000-0000-0000-000000001004','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000904','2026-08-31','2026-09-01','2027-08-31',800,'USD','annual',30,'invoiced','2026-08-01 10:00:00+03','00000000-0000-0000-0000-000000001105'),
...
('00000000-0000-0000-0000-000000001009','00000000-0000-0000-0000-000000000103','00000000-0000-0000-0000-000000000909','2026-09-15','2026-09-16','2027-09-15',750,'USD','quarterly',30,'invoiced','2026-08-02 10:00:00+03','00000000-0000-0000-0000-000000001106'),
...
on conflict (id) do update set
  renewal_value=excluded.renewal_value, status=excluded.status, requested_at=excluded.requested_at,
  invoice_id=excluded.invoice_id, renewal_start_date=excluded.renewal_start_date,
  renewal_expiry_date=excluded.renewal_expiry_date;
...
begin
  ...
  ('00000000-0000-0000-0000-000000001102','INV/2026/09002','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000701','00000000-0000-0000-0000-000000000802','manual',null,'Atlas Marina quarterly billing','USD',900,0,900,'2026-08-01','2026-08-15','quarterly',14,'issued','First installment already received.',v_admin),
  ('00000000-0000-0000-0000-000000001103','INV/2026/09003','00000000-0000-0000-0000-000000000102','00000000-0000-0000-0000-000000000703','00000000-0000-0000-0000-000000000805','manual',null,'Cedar Table semi-annual licence','USD',700,0,700,'2026-07-20','2026-08-03','semi_annual',14,'issued','Partially settled by first installment.',v_admin),
  ('00000000-0000-0000-0000-000000001104','INV/2026/09004','00000000-0000-0000-0000-000000000103','00000000-0000-0000-0000-000000000704','00000000-0000-0000-0000-000000000807','manual',null,'Riyadh Eats monthly subscription','USD',1200,0,1200,'2026-07-11','2026-08-10','monthly',30,'issued','Monthly payment schedule demo.',v_admin),
  ('00000000-0000-0000-0000-000000001105','INV/2026/09005','00000000-0000-0000-0000-000000000101','00000000-0000-0000-0000-000000000702','00000000-0000-0000-0000-000000000804','renewal','00000000-0000-0000-0000-000000001004','Palm Suites renewal','USD',800,0,800,'2026-07-26','2026-08-25','annual',30,'issued','Renewal invoice awaiting payment.',v_admin),
  ...
  ('00000000-0000-0000-0000-000000001107','INV/2026/09007','00000000-0000-0000-0000-000000000103','00000000-0000-0000-0000-000000000706','00000000-0000-0000-0000-000000000810','manual',null,'Coastal Catering annual licence','USD',1100,0,1100,'2026-06-30','2026-07-30','annual',30,'issued','Partial payment received; remaining balance overdue.',v_admin),
  ('00000000-0000-0000-0000-000000001108','INV/2026/09008','00000000-0000-0000-0000-000000000104',null,null,'manual',null,'Reseller onboarding and enablement','USD',500,0,500,'2026-08-15','2026-09-05','annual',21,'issued','Direct reseller invoice without end-client reference.',v_admin)
  on conflict (id) do update set
    invoice_number=excluded.invoice_number, reseller_id=excluded.reseller_id, client_id=excluded.client_id,
    location_id=excluded.location_id, source_type=excluded.source_type, source_id=excluded.source_id,
    reference=excluded.reference, subtotal=excluded.subtotal, tax=excluded.tax, total=excluded.total,
    issued_at=excluded.issued_at, due_date=excluded.due_date, billing_frequency=excluded.billing_frequency,
    payment_term_days=excluded.payment_term_days, status=excluded.status, notes=excluded.notes, created_by=excluded.created_by;
end $$;
...
('00000000-0000-0000-0000-000000001205','00000000-0000-0000-0000-000000001105','Renewal - InCheck Full - Palm Suites Corniche',1,800),
('00000000-0000-0000-0000-000000001206','00000000-0000-0000-0000-000000001106','Renewal - InCheck Full - Desert Roastery Tahlia',1,750),
...
-- ---------------------------------------------------------------------------
-- Payment schedules: annual, semi-annual, quarterly and monthly examples
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Payments and receipt issuance history
-- ---------------------------------------------------------------------------
do $$
declare v_admin uuid;
begin
  ...
  (id,reseller_id,amount,currency,paid_at,method,reference,notes,created_by)
  values
  ('00000000-0000-0000-0000-000000001401','00000000-0000-0000-0000-000000000101',825,'USD','2026-08-02','bank_transfer','GB-TRX-0802-01','Full settlement of Atlas Downtown invoice.',v_admin),
  ...
  on conflict (id) do update set
    amount=excluded.amount, paid_at=excluded.paid_at, method=excluded.method,
    reference=excluded.reference, notes=excluded.notes, created_by=excluded.created_by;

  insert into public.receipts
  (id,receipt_number,payment_id,reseller_id,amount,currency,issued_at,status,created_by)
  values
  ...
  on conflict (id) do update set
    receipt_number=excluded.receipt_number, amount=excluded.amount,
    issued_at=excluded.issued_at, status=excluded.status, created_by=excluded.created_by;
end $$;
...
-- ---------------------------------------------------------------------------
-- New-client and add-location requests
-- ---------------------------------------------------------------------------
do $$
declare v_admin uuid;
begin
  ...
  ('00000000-0000-0000-0000-000000001602','REQ/2026/09002','00000000-0000-0000-0000-000000000101',v_admin,'add_location',null,'00000000-0000-0000-0000-000000000701','Atlas Jumeirah','United Arab Emirates','Dubai','InCheck Full',1,825,125,'USD','2026-09-15','annual',30,'Existing client expansion request.',null,'pending',null,null),
  ('00000000-0000-0000-0000-000000001603','REQ/2026/09003','00000000-0000-0000-0000-000000000104',v_admin,'new_client','00000000-0000-0000-0000-000000000212',null,'Olive Branch - Abdoun','Jordan','Amman','InCheck Basic',1,350,75,'USD','2026-09-01','annual',21,'Initial request submitted before qualification.','Lead needs further qualification before activation.','rejected',null,'2026-08-09 12:00:00+03'),
  ('00000000-0000-0000-0000-000000001604','REQ/2026/09004','00000000-0000-0000-0000-000000000102',v_admin,'add_location',null,'00000000-0000-0000-0000-000000000703','Cedar Table Hazmieh','Lebanon','Baabda','InCheck Basic',1,350,100,'USD','2025-11-01','annual',14,'Historical fulfilled location request.','Approved and activated.','fulfilled','00000000-0000-0000-0000-000000001103','2025-10-20 10:00:00+03'),
  ...
  ('00000000-0000-0000-0000-000000001606','REQ/2026/09006','00000000-0000-0000-0000-000000000103',v_admin,'add_location',null,'00000000-0000-0000-0000-000000000704','Riyadh Eats - Nakheel Mall','Saudi Arabia','Riyadh','InCheck Full',1,1200,160,'USD','2026-09-01','monthly',30,'Expansion location requested by client.','Commercials approved; invoice preparation pending.','approved',null,'2026-08-11 15:00:00+03')
  on conflict (id) do update set
    status=excluded.status, notes=excluded.notes, admin_notes=excluded.admin_notes,
    invoice_id=excluded.invoice_id, reviewed_at=excluded.reviewed_at, requested_by=excluded.requested_by;
end $$;
...
-- ---------------------------------------------------------------------------
-- Optional reseller-login mapping examples
-- ---------------------------------------------------------------------------
-- The seed intentionally does NOT create Auth passwords/users directly.
-- To test a reseller-specific login, create a user in Supabase Authentication,
-- then assign it to one of the demo resellers, for example:
--
-- update public.profiles
-- set full_name='Demo GulfBridge User',
--     role='reseller_admin',
--     reseller_id='00000000-0000-0000-0000-000000000101'
-- where email='partner@example.com';
--
-- Available demo reseller IDs:
